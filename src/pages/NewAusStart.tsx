...
const NewAusStart: React.FC = () => {
    ...
    return (
        <div className="container py-4">
            <h2 className="mb-4" style={{ color: '#3399cc' }}>AUS Certificate <span style={{ fontWeight: 400, fontSize: 24, color: '#666' }}>»New AUS</span></h2>
