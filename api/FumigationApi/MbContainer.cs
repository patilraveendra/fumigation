...
public class AusContainer
{
    ...
    [JsonIgnore] public AusCertificate Certificate { get; set; } = null!;
}

public class AusCertificate
{
    [Key]
    public int CertificateId { get; set; }

    public string CertificateType { get; set; } = "AUS";
    public string CertificateNumber { get; set; } = string.Empty;
    ...
    public ICollection<AusContainer> Containers { get; set; }
        = new List<AusContainer>();
}